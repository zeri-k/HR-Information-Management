...
namespace PIM
{
    public partial class DnPnRForm : Form
    {
        string depart;
        string position;
        string rank;
        ...
        private void search()
        {
            ...
            if (cmbPosition.Text == "" && txtJobRank.Text == "")
            {
                commandString = commandString + "where department='" + depart + "'";
                dgv(commandString);
            }
            else if (cmbDepartment.Text == "" && txtJobRank.Text == "")
            {
                commandString = commandString + "where jobposition='" + position + "'";
                dgv(commandString);
            }
            else if (cmbDepartment.Text == "" && cmbPosition.Text == "")
            {
                commandString = commandString + "where jobrank1=" + rank;
                dgv(commandString);
            }
            else if(txtJobRank.Text == "")
            {
                commandString = commandString + "where department='" + depart + "' and jobposition='" + position + "'";
                dgv(commandString);
            }
            ...
            {
                commandString = commandString + "where jobposition='" + position + "' and jobrank1=" + rank;
                dgv(commandString);
            }
            else
            {
                commandString = commandString + "where department='" + depart + "' and jobposition='" + position + "' and jobrank1=" + rank;
                dgv(commandString);
            }
        }
