...
namespace PIM
{
    public partial class PositionForm : Form
    {
        ...
        public PositionForm(string Position)
        {
            InitializeComponent();
        ...
        private void PositionForm_Load(object sender, EventArgs e)
        {
            try
            {
                string commandString = "select emp_num, emp_name, department, jobposition, join_day1, join_day2, join_day3, " +
                    "hl_edu, cellphone1, cellphone2, cellphone3, E_Mail from pers_info where jobposition='" + Position + "'";
                ...
                while (myReader.Read())
                {
                    ...
                    dgvPositionList["Col5", i].Value = myReader.GetInt32(4).ToString("0000") + "/" + myReader.GetInt32(5).ToString("00") + "/" + myReader.GetInt32(6).ToString("00");
                    dgvPositionList["Col6", i].Value = myReader.GetString(7);
                    dgvPositionList["Col7", i].Value = myReader.GetInt32(8).ToString("000") + "-" + myReader.GetInt32(9).ToString("0000") + "-" + myReader.GetInt32(10).ToString("0000");
                    dgvPositionList["Col8", i].Value = myReader.GetString(11);
        ...
        private void tsmPrint_Click(object sender, EventArgs e)
        {
            ...
            {
                printDocument1.DocumentName = "직위별 사원대장";
